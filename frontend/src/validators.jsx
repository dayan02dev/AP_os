...
import { useState as useVS, useEffect as useVE, useRef as useVR } from "react";
...
export {
  validateEmail, suggestEmailDomains,
  isPasswordValid, checkPasswordRules, scorePasswordStrength,
