...
const SECTIONS = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        help: "Names of the programs, dates, any funding or grants received, and the nature of support (mentorship, infrastructure, equity, etc.). Note: DST rules prevent companies from drawing DST grants from multiple sources.",
