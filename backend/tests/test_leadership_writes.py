...
def test_legal_next_states_for_evaluated():
    # jury_review added when approve→jury_review path introduced
    assert legal_next_states("evaluated") == ["jury_review", "on_hold", "rejected", "shortlisted", "waitlisted", "withdrawn"]
